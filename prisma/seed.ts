...
const games = [
  ...
  { key: 'ROULETTE' as const, name: 'VÒNG QUAY CHÂU ÂU', subtitle: 'Đặt cửa, quay là ăn', sortOrder: 3, minBet: 1000n, maxBet: 10000000n, config: { straightX: 36, dozenX: 3, evenMoneyX: 2 } },
];
