...
import {errorHandler,AppError} from './lib/http.js';
...
export function createApp(){
 ...
 app.use((_req,_res,next)=>next(new AppError(404,'Không tìm thấy API','NOT_FOUND')));app.use(errorHandler);return app;
}
